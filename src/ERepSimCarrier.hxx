...
public:
    ...
    Carrier(const TG4Event* event, const TG4HitSegment* hitSegment,
            int sensorId, int segmentId);
    virtual ~Carrier();
...
private:
    ...
    /// The segment that created this carrier.  This hit segment has been
    /// modified to refer to the adjusted trajectory id (only applies when
    /// events are being combined.).
    TG4HitSegment fHitSegment;
